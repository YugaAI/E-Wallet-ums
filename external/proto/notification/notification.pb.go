...
type SendNotificationRequest struct {
	...
	UserId        int64                  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // target user
	Channels      []string               `protobuf:"bytes,3,rep,name=channels,proto3" json:"channels,omitempty"`            // e.g., ["email","push"]
	Payload       *NotificationPayload   `protobuf:"bytes,4,opt,name=payload,proto3" json:"payload,omitempty"`              // envelope payload
...
func (x *SendNotificationRequest) GetEvent() string {
	if x != nil {
		return x.Event
	}
	return ""
...
type NotificationPayload struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         *EmailPayload          `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Push          *PushPayload           `protobuf:"bytes,2,opt,name=push,proto3" json:"push,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NotificationPayload) GetEmail() *EmailPayload {
	if x != nil {
		return x.Email
	}
	return nil
...
func (x *NotificationPayload) GetPush() *PushPayload {
	if x != nil {
		return x.Push
	}
	return nil
...
type PushPayload struct {
	...
	Data          map[string]string      `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // key-value extra
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SendNotificationResponse struct {
	...
	Status         string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"` // pending, processing, success, partial_failed
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_notification_proto_rawDesc = "" +
	"\n" +
	"\x12notification.proto\x12\fnotification\"\xa1\x01\n" +
	...
	"\apayload\x18\x04 \x01(\v2!.notification.NotificationPayloadR\apayload\"v\n" +
	"\x13NotificationPayload\x120\n" +
	"\x05email\x18\x01 \x01(\v2\x1a.notification.EmailPayloadR\x05email\x12-\n" +
	"\x04push\x18\x02 \x01(\v2\x19.notification.PushPayloadR\x04push\"L\n" +
	"\fEmailPayload\x12\x0e\n" +
	"\x02to\x18\x01 \x01(\tR\x02to\x12\x18\n" +
	"\asubject\x18\x02 \x01(\tR\asubject\x12\x12\n" +
	"\x04body\x18\x03 \x01(\tR\x04body\"\xa9\x01\n" +
	"\vPushPayload\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x12\n" +
	"\x04body\x18\x02 \x01(\tR\x04body\x127\n" +
	"\x04data\x18\x03 \x03(\v2#.notification.PushPayload.DataEntryR\x04data\x1a7\n" +
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"[\n" +
	"\x18SendNotificationResponse\x12'\n" +
	"\x0fnotification_id\x18\x01 \x01(\x03R\x0enotificationId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status2x\n" +
	"\x13NotificationService\x12a\n" +
	"\x10SendNotification\x12%.notification.SendNotificationRequest\x1a&.notification.SendNotificationResponseB-Z+notification-system/internal/notificationpbb\x06proto3"
...
var file_notification_proto_goTypes = []any{
	...
	(*NotificationPayload)(nil),      // 1: notification.NotificationPayload
	(*EmailPayload)(nil),             // 2: notification.EmailPayload
	(*PushPayload)(nil),              // 3: notification.PushPayload
	(*SendNotificationResponse)(nil), // 4: notification.SendNotificationResponse
	nil,                              // 5: notification.PushPayload.DataEntry
}
var file_notification_proto_depIdxs = []int32{
	1, // 0: notification.SendNotificationRequest.payload:type_name -> notification.NotificationPayload
	2, // 1: notification.NotificationPayload.email:type_name -> notification.EmailPayload
	3, // 2: notification.NotificationPayload.push:type_name -> notification.PushPayload
	5, // 3: notification.PushPayload.data:type_name -> notification.PushPayload.DataEntry
	0, // 4: notification.NotificationService.SendNotification:input_type -> notification.SendNotificationRequest
	4, // 5: notification.NotificationService.SendNotification:output_type -> notification.SendNotificationResponse
